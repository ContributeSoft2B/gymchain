var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var eleObj = document.getElementById("mydiv");
		var canvasObj = document.createElement("canvas");
		var slidObj = document.getElementById("slider");
		...
		//eleObj.style.padding = "0";
		//eleObj.style.margin = "0";
		// eleObj.replaceChild(canvas.element, canvasDiv);
		eleObj.appendChild(canvas.element);
		...
		eleObj.onmousemove = function(e){
			var event = e || window.event;

			canvas.mouse = {
				x: event.clientX,
				y: event.clientY - (eleObj.offsetTop+slidObj.clientHeight+116) +document.documentElement.scrollTop
			}
		}
