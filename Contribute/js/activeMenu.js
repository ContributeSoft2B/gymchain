	            ...
	            <div class="col-lg-12 col-md-12 col-sm-5 col-xs-12 arabic-display-none-new">\
	                <div class="footer-follow-us-wrap">\
	                    ...
	                    <ul class="footer-follow-us-icon-list">\
	                        ...
	                        <li><a href="javascript:;" title="Medium soft2b.com"><i class="fa fa-weixin" aria-hidden="true"><span class="inner"><img src="/images/1420920937.jpg" class="wximg"></span></i></a>\
	                            \
	                        </li>\
	                    </ul>\
	                </div>\
...
$(function (e) {
    ...
    e("ul.mob-menu li ul").addClass("sub-menu");
    e("ul.mob-menu .parentLi > a").append("▼");
    e("ul.mob-menu .sub-menu").hide();
    e("ul.mob-menu .parentLi > a").on("click", function (i) {
        i.preventDefault(), e(this).toggleClass("expanded"), e(this).parent().find("ul.sub-menu").slideToggle()
    });
    e(".mobile-language li").has("ul").addClass("parentLi").prepend('<a href="#" class="caret"></a>');
    e(".lang-submenu").hide();
    e(".mobile-language .caret").on("click", function (i) {
